        ...
        <div class="mb-16 flex flex-wrap">
                    ...
                    @auth
                        ...
                        onHandleAttending() {axios.post(`/events-attending/{!! $event->id!!}`).then( res => {this.attending = res.data})}
                            ...
                            <button type="button" x-on:click="onHandleLike"
                                    class="text-white  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 hover:bg-blue-700"
                            ...
                            <button type="button" title="Підписатись на зміни, коментарі, видалення, тощо" x-on:click="onHandleAttending"
                                    class="text-white  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 hover:bg-blue-700"
            ...
            <div class="w-full shrink-0 grow-0 lg:w-6/12 lg:pl-6 bg-slate-50 rounded-md p-2">
                <p class="mb-6 text-sm text-yellow-600">
                    Старт: <time>{{ $event->start_time }}</time>
                </p>
                <p>
                        ...
                        <div class="">
                            <form action="{{route('events.comments',$event->id)}}" class="flex justify-between space-x-2"
                                ...
                                <input type="text"
                                       ...
                                       name="content" id="content" placeholder="Коментар">
                                <button type="submit"
