    ...
    <x-slot name="header">
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <div class="flex justify-between">
                <h1 class="text-3xl font-bold tracking-tight text-gray-900">{{__('Події')}}</h1>
                            ...
                            <tr class="border-b odd:bg-white even:bg-slate-100">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex space-x-2">
                                        <a href="{{ route('events.edit', $event) }}" title="Редагувати"
                                        ...
                                        <form method="POST" class="text-red-400 hover:text-red-600"
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <a href="{{ route('events.destroy', $event) }}" title="Видалити"
